...
<%@page import="ib_renderer.css.parser.property.OneToFourPropertyBuilders.BorderColor"%>
...
<%
    ...
    try {
        ...
        String tempRoot = "D:/temp/";
        down.setTempRoot(tempRoot);
		...
		*/
		...
		// #####################################################################################
		// STEP 2. 생성된 엑셀 문서를 서버에 저장
		String fileName = down.getFileName();
		down.saveToFile("d:/temp/");

		File file = new File("d:/temp/"  + fileName); 
		FileInputStream fis = null;
		
		//다운로드 받을 파일을 읽어서 보더를 넣는다. 
