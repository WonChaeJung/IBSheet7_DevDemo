...
ibleaders = {
     ...
     */
    // license: "license",
    license: "W2FtSztPKCVwZDYyYjJxbiwPakoyRD1yICZmej5jMn8gIxonWD1XYTI0fzFnMCgmY2shST9CNA=="
...
function getContextPath(){
    ...
    var ctxPath=location.href.substring(offset,location.href.indexOf('/',offset+0));
    return ctxPath;
}
//ibsheet 공통 cfg 설정
var _sheetCFG = {
	    "Cfg" : {
	        "Down2Excel_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/Down2Excel.jsp",
	        "LoadExcel_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/LoadExcel.jsp",
	        "DirectLoadExcel_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/DirectLoadExcel.jsp",
	        "Down2Text_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/Down2Text.jsp",
	        "LoadText_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/LoadText.jsp",
	        "Down2Pdf_Url" : contextRoot+"/resource/common/IBSheet7/sheet/jsp/Down2Pdf.jsp",
